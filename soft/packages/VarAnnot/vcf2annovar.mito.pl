...
my ($VERBOSE, $HELP, $MAN);
my ($INFILE, $ID, $BUILDVER, $VARIANT_CALLER, $HEADER, $DBSNP, $EXCLUDE, $INCLUDE);
...
sub processArguments {
    ...
    GetOptions('verbose|v'=>\$VERBOSE, 'help'=>\$HELP, 'man|m'=>\$MAN, 'infile|i=s'=>\$INFILE, 'outfile|o=s'=>\$OUTFILE, 'identifier|id=s'=>\$ID, 'buildver|b=s'=>\$BUILDVER, 'vcaller|vc=s'=>\$VARIANT_CALLER, 'header|h=s'=>\$HEADER, 'dbsnp|d=s'=>\$DBSNP, 'exclude|e=s'=>\$EXCLUDE, 'include|inc=s'=>\$INCLUDE) || pod2usage();
...
#        $headerNotice = "NOTICE : no --header argument provided : no header file will be used during analysis...\n";
    ...
    $SUBOUTPATH = $OUTPATH . $ID . "_ANNOVAR.MITO_analysis_files_" . $date . "/";
    mkpath $SUBOUTPATH, 002;

    $ANNOINFILE                 = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_input." . $VARIANT_CALLER . "." . $BUILDVER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_input." . $BUILDVER;
    $OUTFILE_ANNO               = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_geneanno_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_geneanno_output";
    $OUTFILE_DBSNP              = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_dbsnp_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_dbsnp_output";
    $OUTFILE_1000G              = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_output";
    $OUTFILE_TSI                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_tsi_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_tsi_output";
    $OUTFILE_ASN                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_asn_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_asn_output";
    $OUTFILE_AFR                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_afr_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_afr_output";
    $OUTFILE_AMR                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_amr_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_amr_output";
    $OUTFILE_EUR                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_eur_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_1000g_eur_output";
    $OUTFILE_CG                 = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_cg_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_cg_output";
    $OUTFILE_SIFT               = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_sift_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_sift_output";
    $OUTFILE_PP2                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_pp2_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_pp2_output";
    $OUTFILE_MT                 = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_mt_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_mt_output";
    $OUTFILE_LRT                = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_lrt_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_lrt_output";
    $OUTFILE_PHYLOP             = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_phylop_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_phylop_output";
    $OUTFILE_GERP               = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_gerp++_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_gerp++_output";
    $OUTFILE_ESP6500            = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_esp6500_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_esp6500_output";
    $OUTFILE_MIRNA              = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_mirna_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_mirna_output";
    $OUTFILE_MIRNATARGET        = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_mirnatarget_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_mirnatarget_output";
    $OUTFILE_RNASEQ_CUFF        = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_rnaseq_Cufflinks_allTissues_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_rnaseq_Cufflinks_allTissues_output";
    $OUTFILE_RNASEQ_SCRI        = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_rnaseq_Scripture_allTissues_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_rnaseq_Scripture_allTissues_output";
    $OUTFILE_GTX_CHIPSEQ        = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_chipseq_sites_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_chipseq_sites_output";
    $OUTFILE_GTX_CLINVAR        = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_clinvar_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_clinvar_output";
    $OUTFILE_GTX_COMMON_SNP     = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_common_snp_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_common_snp_output";
    $OUTFILE_GTX_COSMIC         = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_cosmic_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_cosmic_output";
    $OUTFILE_GTX_CPG            = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_cpg_islands_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_cpg_islands_output";
    $OUTFILE_GTX_DBNSFP         = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_dbnsfp_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_dbnsfp_output";
    $OUTFILE_GTX_DISEASE        = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_disease_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_disease_output";
    $OUTFILE_GTX_DRUG           = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_drug_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_drug_output";
    $OUTFILE_GTX_EVS            = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_evs_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_evm_output";
    $OUTFILE_GTX_GWAS           = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_gwas_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_gwas_output";
    $OUTFILE_GTX_HGMD           = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_hgmd_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_hgmd_output";
    $OUTFILE_GTX_HGMD_DISGENE   = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_hgmd_disease_genes_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_hgmd_disease_genes_output";
    $OUTFILE_GTX_MICROSAT       = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_microsatellites_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_microsatellites_output";
    $OUTFILE_GTX_MIRNA          = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_mirna_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_mirna_output";
    $OUTFILE_GTX_OMIM           = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_omim_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_omim_output";
    $OUTFILE_GTX_PATH           = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_pathway_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_pathway_output";
    $OUTFILE_GTX_PGX            = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_pgx_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_pgx_output";
    $OUTFILE_GTX_PTMS           = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_ptms_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_ptms_output";
    $OUTFILE_GTX_TRANSFAC       = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_transfac_sites_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_transfac_sites_output";
    $OUTFILE_GTX_TSS            = ($VARIANT_CALLER) ? $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_tss_output." . $VARIANT_CALLER : $SUBOUTPATH . $ID . "_ANNOVAR.MITO_GenomeTrax_tss_output";

    my $logFile = $SUBOUTPATH . $ID . "_ANNOVAR.MITO_unresolved.log";
...
sub convertVcf {
    ...
    $VERBOSE and printerr("\n**********\n* Starting converting vcf input to annovar input file using the following command line :\n* perl $ANNOVARPATH/convert2annovar.pl --format vcf4old --allallele --includeinfo --outfile $ANNOINFILE $VERBOSE $INFILE\n**********\n\n");
    system "perl $ANNOVARPATH/convert2annovar.pl --format vcf4old --allallele --includeinfo --outfile $ANNOINFILE $VERBOSE $INFILE";
    ...
    while (my $inputLine = <ANNOINFILE>) {
        chomp $inputLine;
        my ($chrom, $start, $stop, $ref, $var, $vcfChrom, $vcrPos, $vcfJunk, $vcrRef, $vcfVar, @junk) = split /\t+/, $inputLine;
...
sub launchAnnovar {
    ...
    if (doIt(-elem => "gene")) {
        ...
        $VERBOSE and printerr("\n**********\n* Starting genome annotation using the following command line :\n* perl $ANNOVARPATH/annotate_variation.pl -geneanno -dbtype MT_GRCh37_ensGene -buildver $USEDBUILD -splicing_threshold 6 -outfile $OUTFILE_ANNO $ANNOINFILE $ANNOVARPATH/humandb/ -separate -exonicsplicing -transcript_function $VERBOSE\n**********\n\n");
        system "perl $ANNOVARPATH/annotate_variation.pl -geneanno -dbtype MT_GRCh37_ensGene -buildver $USEDBUILD -splicing_threshold 6 -outfile $OUTFILE_ANNO $ANNOINFILE $ANNOVARPATH/humandb/ -separate -exonicsplicing -transcript_function $VERBOSE";
...
sub printVcf {
    ...
    (not $resultFile) and $resultFile = ($VARIANT_CALLER) ? $OUTPATH . $ID . "_ANNOVAR.MITO_output." . $VARIANT_CALLER . "." . $BUILDVER . ".RESULTS.vcf" : $OUTPATH . $ID . "_ANNOVAR.MITO_output." . $BUILDVER . ".RESULTS.vcf";
...
supported choices are : gene (include gene annotation), snp (include dbSNP filter), 1kg (include 1000 Genome filter), cg (include Complete Genomics filter), sift (include SIFT filter), pp2 (include PolyPhen.v2 filter), mt (include Mutation Taster filter), lrt (include LRT filter), phylop (include PhyloP filter), gerp (include gerp++ filter), esp6500 (include esp6500 filter), mirna (include mirna region annotation), mirnatarget (include mirnatarget region annotation), tsi (include filter of allele frequency of Toscani population of 1000genomes project), asn (include filter of allele frequency of East Asian population of 1000genomes project), afr (include filter of allele frequency of African population of 1000genomes project), amr (include filter of allele frequency of Ad Mixed American population of 1000genomes project), eur (include filter of allele frequency of European population of 1000genomes project), rnaseq_cuff (include Broad Cufflinks RNASeq alignment region annotation), rnaseq_scri (include Broad Scripture RNASeq alignment region annotation), gtx_chipseq (include GenomeTrax Predicted ChIP-Seq TFBS description region annotation), gtx_clinvar (include GenomeTrax NCBI\'s ClinVar annotation), gtx_common_snp (include GenomeTrax Common SNPs annotation), gtx_cosmic (include GenomeTrax COSMIC (Catalogue of Somatic Mutations in Cancer) somatic disease mutations description region annotation), gtx_cpg (include GenomeTrax CpG Islands description region annotation), gtx_disease (include GenomeTrax Disease associations description region annotation), gtx_drug (include GenomeTrax Drug Targets description region annotation), gtx_evs (include GenomeTrax EVS annotation), gtx_gwas (include GenomeTrax GWAS Catalogue description region annotation), gtx_hgmd (include GenomeTrax HGMD inherited (germ-line) disease mutations description region annotation), gtx_hgmd_disgene (include GenomeTrax HGMD disease genes description region annotation), gtx_microsat (include GenomeTrax Microsatellite repeats description region annotation), gtx_mirna (include GenomeTrax microRNA sequences description region annotation), gtx_omim (include GenomeTrax NCBI\'s OMIM description region annotation), gtx_path (include GenomeTrax Pathways membership description region annotation), gtx_pgx (include GenomeTrax Pharmacogenomics Variants description region annotation), gtx_ptms (include GenomeTrax Post translational modifications description region annotation), gtx_transfac (include GenomeTrax TRANSFAC experimentally verified TFBS description region annotation), gtx_tss (include GenomeTrax TSSs (transcription start sites) description region annotation)
